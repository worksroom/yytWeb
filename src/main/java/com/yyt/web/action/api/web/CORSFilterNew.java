 ...
 * the License.
 */
package com.yyt.web.action.api.web;
...
/**
 * <p>
 * A {@link javax.servlet.Filter} that enable client-side cross-origin requests by
 * implementing W3C's CORS (<b>C</b>ross-<b>O</b>rigin <b>R</b>esource
 * <b>S</b>haring) specification for resources. Each {@link javax.servlet.http.HttpServletRequest}
 * request is inspected as per specification, and appropriate response headers
 * are added to {@link javax.servlet.http.HttpServletResponse}.
 * </p>
 * <p/>
 * <p>
 ...
 */
public final class CORSFilterNew implements Filter {
    // ----------------------------------------------------- Instance variables
    /**
    ...
    public void doFilter(final ServletRequest servletRequest,
        ...
        if (decorateRequest) {
            CORSFilterNew.decorateCORSProperties(request, requestType);
        }
        switch (requestType) {
            case SIMPLE:
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        ...
        if (filterConfig != null) {
            ...
            String configSupportsCredentials =
                    filterConfig.getInitParameter(PARAM_CORS_SUPPORT_CREDENTIALS);
    ...
    /**
     * Handles a CORS request of type {@link CORSFilterNew.CORSRequestType}.SIMPLE.
     *
     ...
     * @param filterChain The {@link javax.servlet.FilterChain} object.
    ...
    public void handleSimpleCORS(final HttpServletRequest request,
        ...
        final String origin =
                request.getHeader(CORSFilterNew.REQUEST_HEADER_ORIGIN);
        ...
        if (anyOriginAllowed && !supportsCredentials) {
            ...
            response.addHeader(
                    CORSFilterNew.RESPONSE_HEADER_ACCESS_CONTROL_ALLOW_ORIGIN, "*");
        } else {
        ...
        if (supportsCredentials) {
            response.addHeader(
                    CORSFilterNew.RESPONSE_HEADER_ACCESS_CONTROL_ALLOW_CREDENTIALS,
                    "true");
        }
        ...
        if ((exposedHeaders != null) && (exposedHeaders.size() > 0)) {
            ...
            response.addHeader(
                    CORSFilterNew.RESPONSE_HEADER_ACCESS_CONTROL_EXPOSE_HEADERS,
    ...
    public void handlePreflightCORS(final HttpServletRequest request,
        ...
        String accessControlRequestMethod =
                request.getHeader(CORSFilterNew.REQUEST_HEADER_ACCESS_CONTROL_REQUEST_METHOD);
        ...
        String accessControlRequestHeadersHeader =
                request.getHeader(CORSFilterNew.REQUEST_HEADER_ACCESS_CONTROL_REQUEST_HEADERS);
        ...
        if (preflightMaxAge > 0) {
            response.addHeader(
                    CORSFilterNew.RESPONSE_HEADER_ACCESS_CONTROL_MAX_AGE,
                    String.valueOf(preflightMaxAge));
        }

        // Section 6.2.9
        response.addHeader(
                CORSFilterNew.RESPONSE_HEADER_ACCESS_CONTROL_ALLOW_METHODS,
                accessControlRequestMethod);

        // Section 6.2.10
        if ((allowedHttpHeaders != null) && (!allowedHttpHeaders.isEmpty())) {
            response.addHeader(
                    CORSFilterNew.RESPONSE_HEADER_ACCESS_CONTROL_ALLOW_HEADERS,
    ...
    public void handleInvalidCORS(final HttpServletRequest request,
                                  final HttpServletResponse response, final FilterChain filterChain) {
        String origin = request.getHeader(CORSFilterNew.REQUEST_HEADER_ORIGIN);
    ...
    /**
     * Decorates the {@link javax.servlet.http.HttpServletRequest}, with CORS attributes.
     * <ul>
     * <li><b>cors.isCorsRequest:</b> Flag to determine if request is a CORS
     * request. Set to <code>true</code> if CORS request; <code>false</code>
     * otherwise.</li>
     ...
     *
     * @param request         The {@link javax.servlet.http.HttpServletRequest} object.
     * @param corsRequestType The {@link CORSFilterNew.CORSRequestType} object.
     */
        ...
        switch (corsRequestType) {
            case SIMPLE:
                request.setAttribute(
                        CORSFilterNew.HTTP_REQUEST_ATTRIBUTE_IS_CORS_REQUEST, true);
                request.setAttribute(CORSFilterNew.HTTP_REQUEST_ATTRIBUTE_ORIGIN,
                        request.getHeader(CORSFilterNew.REQUEST_HEADER_ORIGIN));
                request.setAttribute(
                        CORSFilterNew.HTTP_REQUEST_ATTRIBUTE_REQUEST_TYPE,
            ...
            case PRE_FLIGHT:
                ...
                request.setAttribute(
                        CORSFilterNew.HTTP_REQUEST_ATTRIBUTE_REQUEST_HEADERS,
                        headers
                );
                break;
            case NOT_CORS:
                request.setAttribute(
                        CORSFilterNew.HTTP_REQUEST_ATTRIBUTE_IS_CORS_REQUEST, false);
                break;
            default:
    ...
    /**
     * Joins elements of {@link java.util.Set} into a string, where each element is
     * separated by the provided separator.
     *
     * @param elements      The {@link java.util.Set} containing elements to join together.
     ...
     * <li>Origin should be a valid {@link java.net.URI}</li>
     * </ul>
     *
     * @param origin
     * @return
    ...
    /**
     * Returns a {@link java.util.Set} of headers that should be exposed by browser.
     *
     * @return
     */
    ...
    /**
     * Returns the {@link java.util.Set} of allowed origins that are allowed to make
     * requests.
     *
    ...
    /**
     * Returns a {@link java.util.Set} of HTTP methods that are allowed to make requests.
     *
     * @return {@link java.util.Set}
     */
    ...
    /**
     * Returns a {@link java.util.Set} of headers support by resource.
     *
     * @return {@link java.util.Set}
     */
    ...
    /**
     * Type of CORS request, of type {@link CORSFilterNew.CORSRequestType}.
     */
    ...
    /**
     * {@link java.util.Collection} of HTTP methods. Case sensitive.
     *
    ...
    public static final Collection<String> HTTP_METHODS = new HashSet<String>(
            Arrays.asList("OPTIONS", "GET", "HEAD", "POST", "PUT", "DELETE",
                    "TRACE", "CONNECT"));
    /**
     * {@link java.util.Collection} of non-simple HTTP methods. Case sensitive.
     */
    public static final Collection<String> COMPLEX_HTTP_METHODS =
            new HashSet<String>(
                    Arrays.asList("PUT", "DELETE", "TRACE", "CONNECT"));
    /**
     * {@link java.util.Collection} of Simple HTTP methods. Case sensitive.
     *
    ...
    /**
     * {@link java.util.Collection} of Simple HTTP request headers. Case in-sensitive.
     *
     * @see http://www.w3.org/TR/cors/#terminology
     */
